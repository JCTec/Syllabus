    ...
    <div style="padding-right: 20px;padding-left: 20px">
        ...
        <div>
            ...
            <div class="float-right" style="padding-right: 30px">
                <img class="exportB" src="<?php echo e(asset('img/export.png')); ?>" width="30px" height="30px">
            </div>
        </div>
                ...
                <form>
                            ...
                            if(selected.trim() != ""){
                                $.ajax({
                                    ...
                                    success: function (data) {
                                        console.log(data);
                                        window.location.href = "<?php echo e(Request::url()); ?>?open=true";
                                    },
                                    error: function (data) {
                                        console.log(data);
                                    }
                            ...
                            $('.exportB').on('click', function () {
                                ...
                                html2canvas(document.querySelector("#mainCol")).then(canvas => {
                                    ...
                                    $('#savePicture').on('click', function () {
                                        ...
                                        var date = new Date();
                                        downloadURI(canvas.toDataURL("image/png"), "<?php echo e($nameMapa); ?>"+ "_" + date.getDate() + "_" + date.getFullYear() + ".png");
                                    });
                                });
                    ...
                    <table id="syllabusTable" cellspacing="0" cellpadding="0">
                        <tr id="mainRowID" class="mainRow">
                            ...
                            <th id="TH2" class="clickable" style="border-bottom:1px solid #757575;" onclick="sortTable(2)"><a class="noA-white" href="<?php echo e(route('competencia', ['CARRERA' => $plan["CODIGO_PLAN"], 'COMPETENCIA' => 'C1'])); ?>">C1</a></th>
                            <th id="TH3" class="clickable" style="border-bottom:1px solid #757575;" onclick="sortTable(3)"><a class="noA-white" href="<?php echo e(route('competencia', ['CARRERA' => $plan["CODIGO_PLAN"], 'COMPETENCIA' => 'C2'])); ?>">C2</a></th>
                            <th id="TH4" class="clickable" style="border-bottom:1px solid #757575;" onclick="sortTable(4)"><a class="noA-white" href="<?php echo e(route('competencia', ['CARRERA' => $plan["CODIGO_PLAN"], 'COMPETENCIA' => 'C3'])); ?>">C3</a></th>
                            <th id="TH5" class="clickable" style="border-bottom:1px solid #757575;" onclick="sortTable(5)"><a class="noA-white" href="<?php echo e(route('competencia', ['CARRERA' => $plan["CODIGO_PLAN"], 'COMPETENCIA' => 'C4'])); ?>">C4</a></th>
                            <th id="TH6" class="clickable" style="border-bottom:1px solid #757575;" onclick="sortTable(6)"><a class="noA-white" href="<?php echo e(route('competencia', ['CARRERA' => $plan["CODIGO_PLAN"], 'COMPETENCIA' => 'C5'])); ?>">C5</a></th>
                            <th id="TH7" class="clickable" style="border-bottom:1px solid #757575;" onclick="sortTable(7)"><a class="noA-white" href="<?php echo e(route('competencia', ['CARRERA' => $plan["CODIGO_PLAN"], 'COMPETENCIA' => 'C6'])); ?>">C6</a></th>
                            <th id="TH8" class="clickable" style="border-bottom:1px solid #757575;" onclick="sortTable(8)"><a class="noA-white" href="<?php echo e(route('competencia', ['CARRERA' => $plan["CODIGO_PLAN"], 'COMPETENCIA' => 'C7'])); ?>">C7</a></th>
                            <th id="TH9" class="clickable" style="border-bottom:1px solid #757575;" onclick="sortTable(9)"><a class="noA-white" href="<?php echo e(route('competencia', ['CARRERA' => $plan["CODIGO_PLAN"], 'COMPETENCIA' => 'C8'])); ?>">C8</a></th>
                            <th id="TH10" class="clickable" style="border-bottom:1px solid #757575;" onclick="sortTable(10)"><a class="noA-white" href="<?php echo e(route('competencia', ['CARRERA' => $plan["CODIGO_PLAN"], 'COMPETENCIA' => 'C9'])); ?>">C9</a></th>
                            <th id="TH11" class="clickable" style="border-bottom:1px solid #757575;" onclick="sortTable(11)"><a class="noA-white" href="<?php echo e(route('competencia', ['CARRERA' => $plan["CODIGO_PLAN"], 'COMPETENCIA' => 'C10'])); ?>">C10</a></th>
                        </tr>
                        ...
                        <?php $__currentLoopData = $materias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $materiaX): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr id="<?php echo e($materia["_id"]); ?>">
                                ...
                                <td><a class="noA" href="<?php echo e(route('materia', ['CARRERA' => $materia["CARRERA"], 'CLAVE' => $materia["CLAVE"]])); ?>"><?php echo e($materia["ASIGNATURA"]); ?></a></td>
                ...
                <div id="chatContent" class="row chat-content">
                    ...
                    <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="talk-bubble btm-left noMargin mainResponser">
                            <?php if($message["userID"] == Auth::user()->id): ?>
                                <div class="imgcontainer">
                                    <span onclick="window.location.href = '<?php echo e(route('remove', ['id' => $message["_id"]])); ?>'" class="close" title="Close PopUp">&times;</span>
                                </div>
                            <?php endif; ?>

                            <h6><?php echo e($message["USER"]); ?></h6>
                            <div id="<?php echo e($message["_id"]); ?>" class="talktext">
