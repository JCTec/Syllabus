...
<html lang="<?php echo e(app()->getLocale()); ?>">
    ...
    <body style="background-color: #FF8000;background-image: url('<?php echo e(asset('img/foto_anahuac.jpg')); ?>'); background-repeat: no-repeat;background-size: 100% 100%; color: white;">
